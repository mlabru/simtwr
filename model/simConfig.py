...
#/ simCommon
#/ ------------------------------------------------------------------------------------------------
import model.simCommon as simCommon
...
#/ quantidade maxima de aerodromos
#/ ------------------------------------------------------------------------------------------------
xMAX_Aerodromos = 1

#/ quantidade maxima de aeronaves
#/ ------------------------------------------------------------------------------------------------
xMAX_Aeronaves = 50

#/ quantidade maxima de aeronaves ativas
#/ ------------------------------------------------------------------------------------------------
...
#/ posicao dos elementos de tela (( x, y ), ( w, h ))
#/ ------------------------------------------------------------------------------------------------
...
#xSCR_POS [ xSCR_Scope ] = ((   0,   0 ), ( 768, 768 ))
#xSCR_POS [ xSCR_Info ]  = (( 768,   0 ), ( 256,  48 ))
#xSCR_POS [ xSCR_Strip ] = (( 768,  48 ), ( 256, 520 ))  # 520 / xSCR_STP_Height = 13,...(520)
#xSCR_POS [ xSCR_Menu ]  = (( 768, 568 ), ( 256, 100 ))
#xSCR_POS [ xSCR_IMet ]  = (( 768, 638 ), ( 256, 130 ))
#xSCR_POS [ xSCR_Msg ]   = (( 768, 668 ), ( 256, 100 ))
...
#xSCR_POS [ xSCR_Scope ] = ((    0,   0 ), ( 960, 960 ))
#xSCR_POS [ xSCR_Info ]  = (( 1024,   0 ), ( 256,  50 ))
#xSCR_POS [ xSCR_Strip ] = (( 1024,  50 ), ( 256, 710 ))  # 710 / xSCR_STP_Height = 17,..(680)
#xSCR_POS [ xSCR_Menu ]  = (( 1024, 760 ), ( 256, 100 ))
#xSCR_POS [ xSCR_IMet ]  = (( 1024, 840 ), ( 256, 130 ))
#xSCR_POS [ xSCR_Msg ]   = (( 1024, 860 ), ( 256, 100 ))
...
xSCR_POS [ xSCR_Scope ] = ((    0,   0 ), ( 990, 990 ))
xSCR_POS [ xSCR_Info ]  = (( 1024,   0 ), ( 256,  54 ))

xSCR_PIL [ xSCR_Strip ] = (( 1024,  54 ), ( 256, 635 ))  # (635 - 12) / xSCR_STP_Height = 15,..(640)
xSCR_PIL [ xSCR_VoIP ]  = (( 1024, 689 ), ( 256, 100 ))
xSCR_PIL [ xSCR_Menu ]  = (( 1024, 789 ), ( 256, 101 ))
xSCR_PIL [ xSCR_Msg ]   = (( 1024, 890 ), ( 256, 100 ))

xSCR_CTR [ xSCR_Strip ] = (( 1024,  54 ), ( 256, 706 ))  # (706 - 12) / xSCR_STP_Height = 17,..(680)
xSCR_CTR [ xSCR_VoIP ]  = (( 1024, 760 ), ( 256, 100 ))
xSCR_CTR [ xSCR_IMet ]  = (( 1024, 860 ), ( 256, 130 ))
