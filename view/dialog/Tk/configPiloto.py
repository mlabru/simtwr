...
class configPiloto ( dlgConfig.dlgConfig ):
    ...
    def browseForExercicio ( self ):
        ...
        #*/
        l_szDir = data.filepath ( glbDefs.xDIR_EXE )
        #l_log.info ( "Dir for search: " + l_szDir )
        ...
        self._txtFileName.insert ( 0, "data/exe/BR001" )

        #l_log.info ( l_szFileName + " prepared for loading" )
    ...
    def startConfigPanel ( self ):
        ...
        #*/
        l_tkRoot.title ( locDefs.xTXT_Tit + " [Piloto]" )
        ...
        #l_log.info ( l_szFileName + " eh o arquivo a abrir..." )
