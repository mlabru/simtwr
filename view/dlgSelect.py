...
#/ SiCAD / view
#/ ------------------------------------------------------------------------------------------------
import view.guiDialogs as guiDialogs
...
#*  -----------------------------------------------------------------------------------------------
#*/
class dlgSelect ( guiDialogs.guiDialogs ):
    ...
    def __init__ ( self, f_title, f_prompt, f_lstOpc ):
        ...
        #*  inicia a superclass
        #*/
        guiDialogs.guiDialogs.__init__ ( self, f_title )
...
if ( '__main__' == __name__ ):
    ...
    #** -------------------------------------------------------------------------------------------
    #*/
    b, v = askList ( "@T@", "Teste de Selecao:", [ "10", "28" ] )
